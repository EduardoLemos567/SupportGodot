...
internal partial class Vector2Box : HBoxContainer
{
    [Signal] internal delegate void ValueChangedEventHandler(Vector2 value);
    ...
    internal void SetValueNoSignal(Vector2 value)
    {
